...
public static class MarkdownDocumentExtensions
{
    ...
    /// </summary>
    /// <param name="text">The current markdown text.</param>
    /// <returns>The markdown text with the line break appended.</returns>
    public static MarkdownText AppendLineBreak(this MarkdownText text)
    {
        return text.Append(new MarkdownLineBreak());
    }
}
